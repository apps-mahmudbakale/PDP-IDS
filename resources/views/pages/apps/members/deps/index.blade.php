<x-default-layout>
    ...
    @section('breadcrumbs')
        {{ Breadcrumbs::render('members.deps.index') }}
    @endsection
        ...
        <div class="card-header border-0 pt-6">
            ...
            <div class="card-title">
                ...
                <div class="d-flex align-items-center position-relative my-1">
                    ...
                    <input type="text" id="searchInput" class="form-control form-control-solid w-250px ps-13" placeholder="Search DEPs member" />
                </div>
                <!--end::Search-->
            </div>
            <!--end::Card title-->
            ...
            <div class="card-toolbar">
                ...
                <div class="d-flex justify-content-end">
                    <!--begin::Add member-->
                    <a href="{{ route('members.deps.create') }}" class="btn btn-primary">
                        {!! getIcon('plus', 'fs-2', '', 'i') !!}
                        Add DEPs Member
                    </a>
                    <!--end::Add member-->
        ...
        <div class="card-body py-4">
                        ...
                        <tbody>
                            @foreach($members as $member)
                                <tr>
                                    <td>
                                        <div class="d-flex align-items-center">
                                            ...
                                            <div class="d-flex flex-column">
                                                <a href="{{ route('members.deps.show', $member) }}" class="text-gray-800 text-hover-primary">
                                    ...
                                    <td>
                                        <div class="d-flex">
                                            <a href="{{ route('members.deps.edit', $member) }}" class="btn btn-sm btn-icon btn-light-warning me-2" title="Edit">
                                                {!! getIcon('pencil', 'fs-5') !!}
                                            </a>
                                            <form action="{{ route('members.deps.destroy', $member) }}" method="POST" style="display: inline;">
                                                @csrf
                                                @method('DELETE')
            ...
            @else
                <div class="text-center py-10">
                    ...
                    <p class="text-muted">No DEPs members found</p>
                </div>
            @endif
        </div>
        <!--end::Card body-->
