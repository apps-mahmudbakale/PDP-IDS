<x-default-layout>
    ...
    @section('breadcrumbs')
        {{ Breadcrumbs::render('members.deps.show', $member) }}
    @endsection
    ...
    <div class="row">
            ...
            <div class="card">
                ...
                <div class="card-header border-0 pt-6">
                    ...
                    <div class="card-toolbar">
                        <a href="{{ route('members.deps.edit', $member) }}" class="btn btn-primary">
        ...
        <div class="col-lg-4">
            ...
            <div class="card">
                <div class="card-body">
                    <form action="{{ route('members.deps.destroy', $member) }}" method="POST">
                        @csrf
                        @method('DELETE')
