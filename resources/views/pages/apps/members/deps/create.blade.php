<x-default-layout>
    ...
    @section('breadcrumbs')
        {{ Breadcrumbs::render('members.deps.create') }}
    @endsection
    ...
    <div class="card">
        ...
        <div class="card-body py-4">
            <form action="{{ route('members.deps.store') }}" method="POST" enctype="multipart/form-data">
                @csrf
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="d-flex gap-3">
                            ...
                            <a href="{{ route('members.deps.index') }}" class="btn btn-light">Cancel</a>
                        </div>
                    </div>
                </div>
            </form>
