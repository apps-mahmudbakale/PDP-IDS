<x-default-layout>
    ...
    @section('breadcrumbs')
        {{ Breadcrumbs::render('members.nec.show', $member) }}
    @endsection
    ...
    <div class="row">
            ...
            <div class="card">
                ...
                <div class="card-header border-0 pt-6">
                    ...
                    <div class="card-toolbar">
                        <a href="{{ route('members.nec.edit', $member) }}" class="btn btn-primary">
        ...
        <div class="col-lg-4">
            ...
            <div class="card">
                <div class="card-body">
                    <form action="{{ route('members.nec.destroy', $member) }}" method="POST">
                        @csrf
                        @method('DELETE')
