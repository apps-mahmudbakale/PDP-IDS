<x-default-layout>
    ...
    @section('breadcrumbs')
        {{ Breadcrumbs::render('members.nec.index') }}
    @endsection
        ...
        <div class="card-header border-0 pt-6">
            ...
            <div class="card-title">
                ...
                <div class="d-flex align-items-center position-relative my-1">
                    ...
                    <input type="text" id="searchInput" class="form-control form-control-solid w-250px ps-13" placeholder="Search NEC member" />
                </div>
                <!--end::Search-->
            </div>
            <!--end::Card title-->
        ...
        <div class="card-body py-4">
                        ...
                        <tbody>
                            @foreach($members as $member)
                                <tr>
                                    <td>
                                        <div class="d-flex align-items-center">
                                            ...
                                            <div class="d-flex flex-column">
                                                <a href="{{ route('members.nec.show', $member) }}" class="text-gray-800 text-hover-primary">
                                    ...
                                    <td>
                                        <div class="d-flex">
                                            <a href="{{ route('members.nec.edit', $member) }}" class="btn btn-sm btn-icon btn-light-warning me-2" title="Edit">
                                                {!! getIcon('pencil', 'fs-5') !!}
                                            </a>
                                            <form action="{{ route('members.nec.destroy', $member) }}" method="POST" style="display: inline;">
                                                @csrf
                                                @method('DELETE')
            ...
            @else
                <div class="text-center py-10">
                    ...
                    <p class="text-muted">No NEC members found</p>
                </div>
            @endif
        </div>
        <!--end::Card body-->
