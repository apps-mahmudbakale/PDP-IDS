<x-default-layout>
    ...
    @section('breadcrumbs')
        {{ Breadcrumbs::render('members.nwc.create') }}
    @endsection
    ...
    <div class="card">
        ...
        <div class="card-body py-4">
            <form action="{{ route('members.nwc.store') }}" method="POST" enctype="multipart/form-data">
                @csrf
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="d-flex gap-3">
                            ...
                            <a href="{{ route('members.nwc.index') }}" class="btn btn-light">Cancel</a>
                        </div>
                    </div>
                </div>
            </form>
